...
public class AppInitFunction {
    ...
    public void initSystemConfig() throws AppException {
        logger.info("--------------------|SystemConfig初始化|--------------------");
        AppCache.initSystemConfig("app.properties");
        logger.info("------------------|SystemConfig初始化完成|------------------");
    }

    public void initServletContex(ApplicationContext applicationContext, AppCache appCache) throws AppException {
